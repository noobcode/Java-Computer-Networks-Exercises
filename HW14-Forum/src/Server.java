...
public class Server extends UnicastRemoteObject implements IServer{
	...
	@Override
	public synchronized void aperturaForum(INotifyMessage client, String forum) throws RemoteException {
	...
	public synchronized void nuovoMessaggio(String forum, String messaggio) throws RemoteException{
		ArrayList<INotifyMessage> clients = topics.get(forum);
		for(INotifyMessage c: clients)
			c.notifyMsg(forum, messaggio);
	}
